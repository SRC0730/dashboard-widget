...
import { AdvancedLevelComponent } from './advanced-level.component';

describe('AdvancedLevelComponent', () => {
  let component: AdvancedLevelComponent;
  let fixture: ComponentFixture<AdvancedLevelComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [AdvancedLevelComponent, FormsModule, DialogModule, JsonPipe],
    ...
    fixture = TestBed.createComponent(AdvancedLevelComponent);
